...
<p align="center">
  <a href="https://github.com/kevnnard/smart-window/releases/tag/v0.2.0">
    <img alt="version" src="https://img.shields.io/badge/version-v0.2.0-2f855a?style=for-the-badge" />
  </a>
...
- Homebrew uses the GitHub release artifact for `v0.2.0`
...
```bash
./scripts/release-homebrew.sh 0.2.0 "Release notes here"
```
